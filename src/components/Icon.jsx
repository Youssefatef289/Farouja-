...
const Icon = ({ name, className = '', size = 24 }) => {
  const iconPaths = {
    ...
    whatsapp: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M17.472 14.382C17.232 14.282 15.243 13.445 14.914 13.345C14.585 13.245 14.346 13.195 14.107 13.445C13.868 13.695 13.004 14.532 12.775 14.782C12.546 15.032 12.317 15.082 12.077 14.982C11.838 14.882 10.624 14.532 9.185 13.245C7.975 12.158 7.166 10.872 6.937 10.622C6.707 10.372 6.898 10.222 7.077 10.022C7.237 9.852 7.417 9.622 7.597 9.422C7.776 9.222 7.836 9.072 7.956 8.872C8.076 8.672 8.016 8.502 7.927 8.352C7.837 8.202 7.078 6.115 6.808 5.315C6.549 4.545 6.279 4.685 6.07 4.675C5.871 4.665 5.642 4.665 5.412 4.665C5.183 4.665 4.884 4.725 4.615 5.025C4.346 5.325 3.657 5.975 3.657 7.225C3.657 8.475 4.526 9.675 4.655 9.875C4.785 10.075 6.414 12.758 8.823 13.678C10.132 14.178 11.171 14.418 11.99 14.618C12.678 14.788 13.307 14.738 13.816 14.658C14.366 14.568 15.554 13.905 15.833 13.205C16.113 12.505 16.113 11.875 16.033 11.745C15.953 11.615 15.784 11.545 15.544 11.445H17.472Z" fill="currentColor"/>
        <path d="M12 2C6.477 2 2 6.384 2 11.779C2 13.833 2.694 15.728 3.851 17.222L2.5 21.5L6.898 20.177C8.298 21.188 10.072 21.758 12 21.758C17.523 21.758 22 17.374 22 11.779C22 6.184 17.523 2 12 2ZM12 19.851C10.409 19.851 8.893 19.417 7.583 18.603L7.236 18.396L4.375 19.158L5.158 16.386L4.932 16.027C4.04 14.615 3.5 13.011 3.5 11.329C3.5 7.097 7.262 3.659 12 3.659C16.738 3.659 20.5 7.097 20.5 11.329C20.5 15.561 16.738 19 12 19.851Z" fill="currentColor"/>
      </svg>
    ),
    facebook: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    cart: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M1 1H5L7.68 14.39C7.77144 14.8504 8.02191 15.264 8.38755 15.5583C8.75318 15.8526 9.2107 16.009 9.68 16H19C19.4693 16.009 19.9268 15.8526 20.2925 15.5583C20.6581 15.264 20.9086 14.8504 21 14.39L22.6 6H6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
    close: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
